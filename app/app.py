...
def fert_recommend():
    ...
    d = {
        ...
        <br/>4. Plant ‘green manure’ crops like cabbage, corn and brocolli<br/>5. Use mulch (wet grass) while growing crops - Mulch can also include sawdust and scrap soft woods""",
